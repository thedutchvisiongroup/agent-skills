...
### 11.4 Implementation notes (v1.0; j–m added in v1.1; (j) rewritten in v1.2)

Extensions and deviations of the implemented V1 versus the schemas above (a–i verified by the 49-test Bun suite; j–m added in v1.1, verified by the 69-test suite — (j) rewritten in v1.2 for deterministic hash naming, verified by the 77-test suite — see `.agents/runs/2026-08-26-opencode-usage-tracking/reports/`):

...
For conceptual background on how Skills work, see [skills-overview.md](./skills-overview.md).
...
**Default assumption**: The AI agent is already very capable
...
* **Smaller models** (fast, economical): Does the Skill provide enough guidance?
* **Mid-range models** (balanced): Is the Skill clear and efficient?
* **Large frontier models** (powerful reasoning): Does the Skill avoid over-explaining?

What works perfectly for a large model might need more detail for a smaller one. If you plan to use your Skill across multiple models, aim for instructions that work well with all of them.
...
> For complete Skill structure details, see [skills-overview.md](./skills-overview.md#skill-structure).
...
SKILL.md serves as an overview that points the agent to detailed materials as needed, like a table of contents in an onboarding guide. For an explanation of how progressive disclosure works, see [How Skills work](./skills-overview.md#how-skills-work) in the overview.
...
List required packages in your SKILL.md. Verify they're available in the execution environment your agent uses.

### Runtime environment

Skills run in a code execution environment with filesystem access, bash commands, and code execution capabilities. For the conceptual explanation of this architecture, see [skills-overview.md](./skills-overview.md#the-skills-architecture).
...
For complete details on the technical architecture, see [skills-overview.md](./skills-overview.md#how-skills-work).
...
The SKILL.md frontmatter requires `name` (64 characters max) and `description` (1024 characters max) fields. See [skills-overview.md](./skills-overview.md#skill-structure) for complete structure details.

### Token budgets

Keep SKILL.md body under 500 lines for optimal performance. If your content exceeds this, split it into separate files using the progressive disclosure patterns described earlier. For architectural details, see [skills-overview.md](./skills-overview.md#how-skills-work).
...
* [ ] Tested with models of varying capability

...
Consult the [typography reference](reference/typography.md) from the ui-frontend-design skill for detailed guidance on scales, pairing, and loading strategies.

...
Use the ui-frontend-design skill — it contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding — if no design context exists yet, you MUST run teach-impeccable first.
...
Consult the [spatial design reference](reference/spatial-design.md) from the ui-frontend-design skill for detailed guidance on grids, rhythm, and container queries.

...
**First**: Use the ui-frontend-design skill for design principles and anti-patterns.
...
5. **Anti-Patterns (CRITICAL)** - Check against ALL the **DON'T** guidelines in the ui-frontend-design skill. Look for AI slop tells (AI color palette, gradient text, glassmorphism, hero metrics, card grids, generic fonts) and general design anti-patterns (gray on color, nested cards, bounce easing, redundant copy).
...
- **Suggested command**: Which command to use (prefer: /ui-extract, /ui-distill, /ui-arrange, /ui-harden, /ui-clarify, /ui-critique, /ui-delight, /ui-onboard, /ui-colorize, /ui-animate, /ui-audit, /ui-quieter, /ui-bolder, /ui-typeset, /ui-polish, /ui-normalize, /ui-overdrive, /ui-adapt, /ui-optimize — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /ui-extract, /ui-distill, /ui-arrange, /ui-harden, /ui-clarify, /ui-critique, /ui-delight, /ui-onboard, /ui-colorize, /ui-animate, /ui-audit, /ui-quieter, /ui-bolder, /ui-typeset, /ui-polish, /ui-normalize, /ui-overdrive, /ui-adapt, /ui-optimize. You may also suggest other installed skills you're sure exist, but never invent commands.

Examples:
- "Use `/ui-normalize` to align with design system (addresses N theming issues)"
- "Use `/ui-optimize` to improve performance (addresses N performance issues)"
- "Use `/ui-harden` to improve resilience (addresses N edge cases)"
